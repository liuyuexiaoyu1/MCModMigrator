...
class MainWindow(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.auto_yes_chk = QtWidgets.QCheckBox("自动下载低置信度")
        ...
        self.failures_chk = QtWidgets.QCheckBox("完成后列出详情")
        self.failures_chk.setChecked(True)
        self.ignore_fork_chk = QtWidgets.QCheckBox("忽略Fork版模组")
    ...
    def _on_finished(self, result):
        ...
        if report["skipped"]:
            self._log("跳过 %d 个（无法解析）：" % len(report["skipped"]))
